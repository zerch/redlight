...
#else
/**
 * the use of ##__VA_ARGS__ which says "put whatever they had for extra 
 * arguments (...) here". Also notice the use of __FILE__ and __LINE__ 
 * to get the current file:line for the debug message.
 */
